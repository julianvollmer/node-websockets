...
function WebSocketBase(options) {
   ...
   this.masked = false;
    ...
    this.url = url.parse(ourl || 'ws://localhost:3000');
...
function readFrame(data) {
    ...
    switch (frame.opcode) {
        case 0x00:
            ...
            break;
        case 0x01:
            this.emit('message', frame.content.toString());
            break;
        case 0x02:
            this.emit('message', frame.content);
            break;
        case 0x08:
            this.close(frame.content);
            break;
        case 0x09:
            writeFrame.call(this, 0x0a, frame.content);
            break;
        case 0x0a:
            this.emit('pong', frame.content);
            break;
        default:
 ...
 * @return  {Boolean}
 */ 
function writeFrame(opcode, content) {
