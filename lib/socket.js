...
util.inherits(WebSocketSocket, stream.Transform);
...
WebSocketSocket.prototype._writeFrame = function(opcode, content) {
...
WebSocketSocket.prototype.onend = function(err) {
    var reason;
...
WebSocketSocket.prototype._transform = function(chunk, encoding, done) {
