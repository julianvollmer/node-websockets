...
function WebSocketStream() {
    ...
    // this is the current maximum amount of bytes 
    // the RFC 6455 standard allows per frame
    // I think it will blow up node to use this as highWaterMark
    // but I have no idea how I else could filter such frames.
    this.highWaterMark = 18446744073709617000 + 13;
}
 ...
 * @param   {Buffer}    data
 */
WebSocketStream.prototype._transformOutput = function(data) {
